...
public class CaptchaResourceStore extends DefaultResourceStore {
    ...
    public CaptchaResourceStore() {
        ...
        // 2. 添加自定义背景图片
        addResource(CaptchaTypeConstant.SLIDER, new Resource("classpath", "images/a.jpg","default"));
        addResource(CaptchaTypeConstant.SLIDER, new Resource("classpath", "images/b.jpg","default"));
        addResource(CaptchaTypeConstant.SLIDER, new Resource("classpath", "images/c.jpg","default"));
        addResource(CaptchaTypeConstant.SLIDER, new Resource("classpath", "images/d.jpg","default"));
        addResource(CaptchaTypeConstant.SLIDER, new Resource("classpath", "images/e.jpg","default"));
        addResource(CaptchaTypeConstant.SLIDER, new Resource("classpath", "images/f.jpg","default"));
        addResource(CaptchaTypeConstant.SLIDER, new Resource("classpath", "images/g.jpg","default"));
        addResource(CaptchaTypeConstant.SLIDER, new Resource("classpath", "images/h.jpg","default"));
        addResource(CaptchaTypeConstant.SLIDER, new Resource("classpath", "images/i.jpg","default"));
        addResource(CaptchaTypeConstant.SLIDER, new Resource("classpath", "images/j.jpg","default"));

        addResource(CaptchaTypeConstant.ROTATE, new Resource("classpath", "images/a.jpg","default"));
        addResource(CaptchaTypeConstant.ROTATE, new Resource("classpath", "images/b.jpg","default"));
        addResource(CaptchaTypeConstant.ROTATE, new Resource("classpath", "images/c.jpg","default"));
        addResource(CaptchaTypeConstant.ROTATE, new Resource("classpath", "images/d.jpg","default"));
        addResource(CaptchaTypeConstant.ROTATE, new Resource("classpath", "images/e.jpg","default"));
        addResource(CaptchaTypeConstant.ROTATE, new Resource("classpath", "images/f.jpg","default"));
        addResource(CaptchaTypeConstant.ROTATE, new Resource("classpath", "images/g.jpg","default"));
        addResource(CaptchaTypeConstant.ROTATE, new Resource("classpath", "images/h.jpg","default"));
        addResource(CaptchaTypeConstant.ROTATE, new Resource("classpath", "images/i.jpg","default"));
        addResource(CaptchaTypeConstant.ROTATE, new Resource("classpath", "images/j.jpg","default"));
    }
}
