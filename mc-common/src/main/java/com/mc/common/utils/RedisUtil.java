...
public class RedisUtil {
     ...
     * 获取所有给定字段的值
     */
    public static List<Object> hashMultiGet(String key, Collection<Object> fields) {
     ...
     * 为哈希表 key 中的指定字段的整数值加上增量 increment
     */
    public static Double hashIncrByFloat(String key, Object field, double delta) {
     ...
     * 迭代哈希表中的键值对
     */
    public static Cursor<Entry<Object, Object>> hashScan(String key, ScanOptions options) {
     ...
     */
    public static String listBLeftPop(String key, long timeout, TimeUnit unit) {
     ...
     */
    public static String listBRightPop(String key, long timeout, TimeUnit unit) {
     ...
     */
    public static String listRightPopAndLeftPush(String sourceKey, String destinationKey) {
     ...
     */
    public static String listBRightPopAndLeftPush(String sourceKey, String destinationKey, long timeout, TimeUnit unit) {
     ...
     * 获取key集合与多个集合的交集
     */
    public static Set<String> setIntersect(String key, Collection<String> otherKeys) {
     ...
     * 获取两个集合的并集
     */
    public static Set<String> setUnion(String key, String otherKeys) {
     ...
     * 获取key集合与多个集合的并集
     */
    public static Set<String> setUnion(String key, Collection<String> otherKeys) {
        return redisTemplate.opsForSet().union(key, otherKeys);
    }
     ...
     * 获取key集合与多个集合的差集
     */
    public static Set<String> setDifference(String key, Collection<String> otherKeys) {
     ...
     * 随机获取集合中count个元素
     */
    public static List<String> setRandomMembers(String key, long count) {
     ...
     */
    public static Set<String> setDistinctRandomMembers(String key, long count) {
     ...
     * 使用迭代器获取元素
     */
    public static Cursor<String> setScan(String key, ScanOptions options) {
     ...
     */
    public static Long zSetAdd(String key, Set<TypedTuple<String>> values) {
     ...
     */
    public static Double zSetIncrementScore(String key, String value, double delta) {
     ...
     * 获取集合元素, 并且把score值也获取
     */
    public static Set<TypedTuple<String>> zSetRangeWithScores(String key, long start, long end) {
     ...
     */
    public static Set<TypedTuple<String>> zSetRangeByScoreWithScores(String key, double min, double max) {
     ...
     */
    public static Set<TypedTuple<String>> zSetRangeByScoreWithScores(String key, double min, double max, long start, long end) {
     ...
     */
    public static Set<TypedTuple<String>> zSetReverseRangeWithScores(String key, long start, long end) {
     ...
     * 根据Score值查询集合元素, 从大到小排序
     */
    public static Set<TypedTuple<String>> zSetReverseRangeByScoreWithScores(String key, double min, double max) {
     ...
     */
    public static Set<String> zSetReverseRangeByScore(String key, double min, double max, long start, long end) {
     ...
     * 使用迭代器获取
     */
    public static Cursor<TypedTuple<String>> zSetScan(String key, ScanOptions options) {
